-- =================================================================
-- MIGRATION 049: ROBUST USER CREATION & DATA REPAIR
-- =================================================================

-- 1. ENSURE PROFILES.FULL_NAME ALLOWS NULLS (Just in case, to prevent total failure)
ALTER TABLE profiles ALTER COLUMN full_name DROP NOT NULL;

-- 2. RE-CREATE ADMIN_CREATE_USER WITH ROBUST NULL HANDLING
...
-- 3. DATA REPAIR: Find Employees with NO user_id and create them (Optional safety)
-- This logic helps if the user ran into failures before this fix.
-- We can't auto-create them easily because we don't know the password,
-- but a manual RPC call will now work perfectly.
